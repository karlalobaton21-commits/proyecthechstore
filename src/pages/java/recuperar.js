document.addEventListener('DOMContentLoaded', () => {
    ...
    const API_URL = "https://proyecthechstore.onrender.com/api/Recuperar/solicitar-codigo"
    ...
    document.getElementById('recuperar-form').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                localStorage.setItem('correo', JSON.stringify({Correo: datos.Correo}))
                

                //mensaje de exito
                errorDiv.className='bg-green-50 border-green-200 text-green-800 px-4 py-3 rounded-lg';
                errorMsg.textContent='Enviando codigo, Redirigiendo....'
